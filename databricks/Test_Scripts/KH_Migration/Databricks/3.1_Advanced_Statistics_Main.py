...
# MAGIC %md
# MAGIC This notebook runs another notebook, as per the iteration on the active tables list given in csv file AdvancedStats_Config.csv --> placed inside dev(or)prod/Test_Validation/Advanced_Statistics/.
...
AdvancedStats_notebook ='3.1.1_Hive_vs_Synapse_Advanced_Statistics'
#mount the dev/prod container
mount_container( test_container_name)

#Read the AdvancedStats_Config.csv file placed at dev or prod container "/Test_Validation/Advanced_Statistics/" and run the test script for all the active Tables listed in the config file 

#New path created: /mnt/<dev(or)prod>/Test_Validation/AdvancedStats/yyyyMMdd/
...
#Read the AdvancedStats_Config.csv file placed at dev/prod container "/Test_Validation/Advanced_Statistics/" and run the test script for all the active Tables listed in the config file 
with open("/dbfs"+dbfs_mount_path + test_container_name + dest_path + AdvancedStatsConfig,"r") as read_obj:
