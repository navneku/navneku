...
#/home/derek mk tsui/Hive_test_script_prod/schema_tablename_Hive_primary_key.csv
#/home/derek mk tsui/Hive_test_script_prod/schema_tablename_Hive_cat.csv
#/home/derek mk tsui/Hive_test_script_prod/schema_tablename_Hive_num.csv
#/home/derek mk tsui/Hive_test_script_prod/schema_tablename_Hive_date.csv
...
#dm_primary_key.to_csv(f'{export_path}Hive_metadata_table_count.csv',index=False) #shifted this line in the end
#pd.concat(temp_key_list, axis=0).sort_values(['schema_name', 'table_name', 'keys']).to_csv(f'{export_path}Hive_primary_key.csv', index=False)
...
dm_primary_key.to_csv(f'{export_path}Hive_metadata_table_count.csv',index=False)
